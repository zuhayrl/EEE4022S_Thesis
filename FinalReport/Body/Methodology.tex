...
\subsection{Machine Learning Programming and AC Analysis}
...
Due to these factors random forrest was chosen.
The programming for this model was done in python via a Jupyter Notebook, as this is widely used in the industry.
First, to test the random forrest model, a Resistor-Capacitor dataset was used,
...
To create the \gls{eis} dataset for the random forrest model, measurements of signals of varying frequency and amplitude, in solutions of varying salinity would be taken.
...
This would give a total dataset of 360 data points, enough to train the random forrest on.