...
%\newpage
    ...
    \begin{enumerate}
        ...
        My use of artificial intelligence software has been limited to giving overviews of topics, checking grammar, and aiding with {\LaTeX} commands.
...
\newpage
    ...
    With further testing, both the \gls{dc}, and \gls{ac} techniques could be improved to show fruitful results.
