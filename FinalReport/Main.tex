...
\newpage
    ...
    The prototype was designed in two parts, a probe module, which would be lowered down through a hole drilled into the ice shelves to measure the salinity, and a controller, which would be used to send instructions and receive data from the probe.
